...
class SqsConfigurationPartialCredentialsTest {
    ...
    @Test
    void sqsClient_ShouldBeCreatedWithLocalEndpoint() {
        ReflectionTestUtils.setField(sqsConfiguration, "queueUrl", "http://localhost:5001/123456789/test-queue.fifo");
